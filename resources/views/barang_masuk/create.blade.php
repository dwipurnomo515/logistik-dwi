@extends('layouts.app')
@section('content')
<h2 class="mb-4 fw-bold">Pencatatan Barang Masuk</h2>
  ...
  <div class="card-body p-4">
    <form action="{{ route('barang-masuk.store') }}" method="POST">
      ...
      <div class="row mb-4">
        ...
        <div class="col-md-6">
          <label class="form-label fw-semibold">Origin (Asal Barang)</label>
          <input type="text" name="origin" class="form-control" required placeholder="Masukkan Asal Barang">
        </div>
      </div>
